const strings = {
  ...
  description:
    "Un semplice generatore di pattern online per creare modelli SVG ripetibili.",
  description2: "Velocizza il tuo sito web senza compromettere la qualità delle immagini.",
  description3: 
    "Perfetto per sfondi di siti web, abbigliamento, branding, packaging design e altro ancora.",
  keywords:
    "modelli svg, modelli, sfondi svg, sfondi vettoriali, generatore di modelli, creatore di modelli",
  pages: [
    {
      page: "index",
